...
I serve as a reviewer for the [IEEE Transactions on Neural Networks and Learning Systems (TNNLS)](https://cis.ieee.org/publications/t-neural-networks-and-learning-systems), [IEEE Transactions on Cognitive and Developmental Systems (TCDS)](https://cis.ieee.org/publications/t-cognitive-and-developmental-systems), [IEEE Transactions on Neural Systems & Rehabilitation Engineering (TNSRE)](https://www.embs.org/tnsre/), [Cerebral Cortex](https://academic.oup.com/cercor), [Autism Research](https://onlinelibrary.wiley.com/journal/19393806), [European Child & Adolescent Psychiatry](https://link.springer.com/journal/787), and [Frontiers in Neuroinformatics](https://www.frontiersin.org/journals/neuroinformatics). Additionally, I served as a PC member for the International Joint Conference on Artificial Intelligence (IJCAI) in [2022](https://ijcai-22.org/pc-members/), [2023](https://ijcai-23.org/pc-member-list), and [2024](https://ijcai24.org/program-committee-pcs), as well as for the International Conference on Medical Image Computing and Computer Assisted Intervention (MICCAI) 2024 and 2025. I am also an organiser of the [Meta-Learning for Multimodal Data](https://www.turing.ac.uk/research/interest-groups/meta-learning-multimodal-data) Turing interest group and a recipient of the [Post-Doctoral Enrichment Awards (PDEA) 2022 programme](https://www.turing.ac.uk/post-doctoral-enrichment-awards-pdea) from [the Alan Turing Institute](https://www.turing.ac.uk).
