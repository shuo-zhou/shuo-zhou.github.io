...
ninja.data = [{
    ...
    handler: () => {
      ...
      handler: () => {
    ...
    },{id: "collaborators-andrew-swift",
          title: 'Andrew Swift',
          description: "Professor of Cardiothoracic Radiology at Clinical Medicine, School of Medicine and Population Health",
          section: "Collaborators",handler: () => {
              window.location.href = "/collaborators/andy/";
            },},{id: "collaborators-robert-turner",
          title: 'Robert Turner',
          description: "Software Engineer at University of Oxford",
          section: "Collaborators",handler: () => {
              window.location.href = "/collaborators/bob/";
            },},{id: "collaborators-chen-chen",
          title: 'Chen Chen',
          description: "Lecturer in Computer Vision at School of Computer Science",
          section: "Collaborators",handler: () => {
              window.location.href = "/collaborators/chen/";
            },},{id: "collaborators-christopher-r-cox",
          title: 'Christopher R. Cox',
          description: "Assistant Professor of Psychology at Louisiana State University",
          section: "Collaborators",handler: () => {
              window.location.href = "/collaborators/crc/";
            },},{id: "collaborators-dinesh-selvarajah",
          ...
          section: "Collaborators",handler: () => {
              window.location.href = "/collaborators/dinesh/";
            },},{id: "collaborators-gaolang-gong",
          title: 'Gaolang Gong',
          description: "Professor at the State Key Laboratory of Cognitive Neuroscience and Learning, Beijing Normal University",
          section: "Collaborators",handler: () => {
              window.location.href = "/collaborators/ggl/";
            },},{id: "collaborators-haiping-lu",
          title: 'Haiping Lu',
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%73%68%75%6F.%7A%68%6F%75@%73%68%65%66%66%69%65%6C%64.%61%63.%75%6B", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/shuo-zhou", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/shuo-zhou-02754763", "_blank");
        },
      },{
        id: 'social-orcid',
        title: 'ORCID',
        section: 'Socials',
        handler: () => {
          window.open("https://orcid.org/0000-0002-8069-2814", "_blank");
        },
      },{
        id: 'social-rss',
        title: 'RSS Feed',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=b90lZb4AAAAJ", "_blank");
        },
      },{
      id: 'light-theme',
